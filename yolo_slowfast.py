...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', type=str, default="/data/cx/ysp/h2v_screen_live/video/chunwan/1min_baseline.mp4",
                        help='test imgs folder or video or camera')
    parser.add_argument('--output', type=str, default="/data/cx/ysp/h2v_screen_live/video/chunwan/1min_baseline_slowfast.mp4",
